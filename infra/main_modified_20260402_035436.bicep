...
@description('Tags to apply to all resources. Must at minimum include: Environment, Project, ManagedBy, and LastDeployed.')
param tags object = {}
...
// ---------------------------------------------------------------------------
// Application Insights component (APM for the web application)
...
// ---------------------------------------------------------------------------
// Network Security Group for hub management subnet
...
// Network Security Group for spoke app subnet
...
// Network Security Group for spoke data subnet
...
// Network Security Group for spoke integration subnet
...
// Route Table to force-tunnel spoke traffic through Azure Firewall
...
// ---------------------------------------------------------------------------
// Hub Virtual Network hosting shared services
...
// Diagnostic settings for the hub virtual network
...
// ---------------------------------------------------------------------------
// Spoke Virtual Network for application workloads
...
// Azure Firewall protecting outbound traffic from the spoke VNet
...
// Azure Bastion host for secure RDP/SSH access
...
// ---------------------------------------------------------------------------
// Web App hosting the primary application
...
// Staging deployment slot for the Web App
...
// ---------------------------------------------------------------------------
// Azure SQL Server hosting the application database
...
// Virtual Network rule allowing traffic from the spoke data subnet to SQL
...
// Azure SQL Database for the application
...
// Auditing settings for Azure SQL Server
...
// Threat detection policy for Azure SQL Server
...
// Transparent Data Encryption (TDE) configuration for Azure SQL Database
