...
// NOTE: All resources follow CAF-style naming via baseName and include
//       standardized tags (Environment, Project, ManagedBy, LastDeployed).
...
// Standardized tag set applied to all resources
...
resource logAnalytics 'Microsoft.OperationalInsights/workspaces@2023-09-01' = {
  // CAF-aligned workspace for central logging
...
resource appInsights 'Microsoft.Insights/components@2020-02-02' = {
  // Tied to Log Analytics workspace for APM telemetry
...
resource nsgHubMgmt 'Microsoft.Network/networkSecurityGroups@2024-01-01' = {
  // NSG securing hub management subnet
  name: nsgHubMgmtName
  location: location
  tags: defaultTags
  properties: {
...
resource nsgSpokeApp 'Microsoft.Network/networkSecurityGroups@2024-01-01' = {
  // NSG securing application subnet in spoke VNet
...
resource nsgSpokeData 'Microsoft.Network/networkSecurityGroups@2024-01-01' = {
  // NSG securing data subnet in spoke VNet
...
resource nsgSpokeIntegration 'Microsoft.Network/networkSecurityGroups@2024-01-01' = {
  // NSG securing integration subnet in spoke VNet
...
resource nsgHubMgmtDiag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  // Diagnostics for hub management NSG
...
resource nsgSpokeAppDiag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  // Diagnostics for app subnet NSG
...
resource nsgSpokeDataDiag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  // Diagnostics for data subnet NSG
...
resource nsgSpokeIntDiag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  // Diagnostics for integration subnet NSG
...
resource routeTable 'Microsoft.Network/routeTables@2024-01-01' = {
  // Route table forcing spoke outbound through firewall
  name: routeTableName
  location: location
  tags: defaultTags
  properties: {
...
resource hubVnet 'Microsoft.Network/virtualNetworks@2024-01-01' = {
  // Hub VNet hosting shared infrastructure
  name: hubVnetName
  location: location
  tags: defaultTags
  properties: {
...
resource spokeVnet 'Microsoft.Network/virtualNetworks@2024-01-01' = {
  // Spoke VNet hosting application workloads
  name: spokeVnetName
  location: location
  tags: defaultTags
  properties: {
...
resource firewall 'Microsoft.Network/azureFirewalls@2024-01-01' = {
  // Hub firewall enforcing outbound control
  name: firewallName
  location: location
  tags: defaultTags
  properties: {
...
resource keyVault 'Microsoft.KeyVault/vaults@2023-07-01' = {
  // Key Vault for application secrets and keys
  name: keyVaultName
  location: location
  tags: defaultTags
  properties: {
...
resource sqlPasswordSecret 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  // Secret containing SQL admin password
...
resource sqlConnectionStringSecret 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  // Secret containing SQL connection string
...
resource appInsightsKeySecret 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  // Secret containing Application Insights connection string
...
resource storageAccount 'Microsoft.Storage/storageAccounts@2023-05-01' = {
  // Storage account for app data and backups
...
resource storageDiag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  // Diagnostics for storage account (blob service)
...
resource appServicePlan 'Microsoft.Web/serverfarms@2023-12-01' = {
  // App Service plan hosting web apps
...
resource webAppStagingSlot 'Microsoft.Web/sites/slots@2023-12-01' = {
  // Staging deployment slot for web application
  name: 'staging'
  parent: webApp
  location: location
  tags: defaultTags
...
resource webAppDiag 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  // Diagnostics for primary web app
...
resource sqlServer 'Microsoft.Sql/servers@2023-08-01-preview' = {
  // SQL logical server for application database
  name: sqlServerName
  location: location
  tags: defaultTags
  properties: {
...
resource sqlVNetRule 'Microsoft.Sql/servers/virtualNetworkRules@2023-08-01-preview' = {
  // VNet rule allowing spoke data subnet to access SQL
...
resource sqlThreatDetection 'Microsoft.Sql/servers/securityAlertPolicies@2023-08-01-preview' = {
  // Threat detection policy for SQL server
  name: 'default'
  parent: sqlServer
  properties: {
    state: 'Enabled'
...
resource webAppKeyVaultRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  // Grants web app access to Key Vault secrets
...
resource webAppStorageRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  // Grants web app access to storage blobs
...
resource stagingSlotKeyVaultRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  // Grants staging slot access to Key Vault secrets
...
resource stagingSlotStorageRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  // Grants staging slot access to storage blobs
...
resource highCpuAlert 'Microsoft.Insights/metricAlerts@2018-03-01' = {
  // Alert when web app CPU exceeds threshold
...
resource highMemoryAlert 'Microsoft.Insights/metricAlerts@2018-03-01' = {
  // Alert when web app memory exceeds threshold
...
resource sqlDtuAlert 'Microsoft.Insights/metricAlerts@2018-03-01' = {
  // Alert when SQL DTU consumption exceeds threshold
